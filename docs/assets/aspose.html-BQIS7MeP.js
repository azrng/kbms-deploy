import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,d as a,o as i}from"./app-DaCCUZLQ.js";const l={};function p(t,e){return i(),n("div",null,e[0]||(e[0]=[a(`<h2 id="测试例子" tabindex="-1"><a class="header-anchor" href="#测试例子"><span>测试例子</span></a></h2><p>引用包</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>  &lt;ItemGroup&gt;</span></span>
