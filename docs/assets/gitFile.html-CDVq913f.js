import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as d,d as n}from"./app-Bfb6-vFH.js";const a={},t=n(`<h2 id="_1-开始初始化" tabindex="-1"><a class="header-anchor" href="#_1-开始初始化"><span>1. 开始初始化</span></a></h2><p>大家都知道，在开始使用 git 时，我们首先要做的就是执行 <code>git init</code>。这个指令会显示出一个我们都很熟悉的提示，特别是对于那些经常启动但又很快放弃的项目。</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>Initialized empty Git repository in /home/meain/dev/src/git-talk/.git/
