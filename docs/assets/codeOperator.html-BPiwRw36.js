import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as e,d as l}from"./app-D8HBJYTp.js";const s={},d=l(`<h2 id="连接数据库" tabindex="-1"><a class="header-anchor" href="#连接数据库"><span>连接数据库</span></a></h2><h3 id="net连接" tabindex="-1"><a class="header-anchor" href="#net连接"><span>.Net连接</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>server=xxx;port=3306;userid=myuserid;password=pwd123;database=db125;charset=utf8;
