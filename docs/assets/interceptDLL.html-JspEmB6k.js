import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as i,d as l}from"./app-CBxp4zeL.js";const t="/kbms/common/c1fdf6f765474cbd95660870fa28b408.png",s="/kbms/common/79966f0546eb43a8a4b2e1bdc28b05e7.png",d={},a=l(`<h2 id="_1-什么是方法拦截" tabindex="-1"><a class="header-anchor" href="#_1-什么是方法拦截"><span>1. 什么是方法拦截？</span></a></h2><p>方法拦截是指在方法被调用之前或之后，通过插入自定义的代码来修改方法的行为。通过方法拦截，开发人员可以在不修改原始代码的情况下，对方法的输入参数进行验证、修改方法的返回值、记录方法的调用日志等操作。</p><p>本文使用<code>Lib.Harmony</code>库实现第三方库方法的拦截，关于该库站长写过[快学会这个技能-.NET API拦截技法](快学会这个技能-.NET API拦截技法 - Dotnet9[2])一文，大家可以再看看，但该篇文章未介绍非public类及方法如何拦截，本文会有所补充反过来 。</p><h2 id="_2-示例程序拦截" tabindex="-1"><a class="header-anchor" href="#_2-示例程序拦截"><span>2. 示例程序拦截</span></a></h2><h3 id="_2-1-编写取数字段落的程序" tabindex="-1"><a class="header-anchor" href="#_2-1-编写取数字段落的程序"><span>2.1. 编写取数字段落的程序</span></a></h3><p>创建一个<code>.NET</code>类库工程，比如叫<code>TestDll</code>，添加工具类<code>TestTool</code>：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>namespace TestDll;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的方法<code>GetNumberSentence</code>逻辑：传入一个整型<code>number</code>参数，除10（集合_sentences项数）取模，返回10以内的数字美文段落，其中如果模为6会取数字1的段落（这是为了验证拦截逻辑设计添加的）。</p><p>下面是写的一个<code>AvaloniaUI</code>程序测试界面</p><figure><img src="`+t+`" alt="图片" tabindex="0" loading="lazy"><figcaption>图片</figcaption></figure><h3 id="_2-2-为什么个位数字为6时-总是显示数字1的段落呢" tabindex="-1"><a class="header-anchor" href="#_2-2-为什么个位数字为6时-总是显示数字1的段落呢"><span>2.2. 为什么个位数字为6时，总是显示数字1的段落呢？</span></a></h3><p>分析上面的代码，我们想把<code>mo == 6</code>时让<code>mo = 1</code>逻辑去掉，除了使用<code>dnSpy</code>这些反编译工具修改代码，我们还可以使用<code>Lib.Harmony</code>（快学会这个技能-.NET API拦截技法 - Dotnet9[3]）拦截<code>GetNumberSentence</code>方法。</p><ol><li>安装<code>Lib.Harmony</code>包</li></ol><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>&lt;PackageReference Include=&quot;Lib.Harmony&quot; Version=&quot;2.3.0-prerelease.2&quot; /&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol><li>编写拦截替换类</li></ol><p>参考快学会这个技能-.NET API拦截技法 - Dotnet9[4]添加如下拦截替换类：</p><ul><li>在拦截类上注册需要拦截的原类类型、原方法名和参数数据类型</li><li>可以先将原方法内代码复制到拦截替换方法<code>Prefix</code>内，对于原类中的属性、字段可通过反射获取(比如<code>_sentences</code>集合)</li><li>将<code>mo == 6</code>的代码注释</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>using HarmonyLib;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>验证方法定义如下：</p><ul><li><code>CalNumber</code>类和<code>GetValidNumber</code>方法用<code>internal</code>声明，意为类或方法只能在当前工程内使用</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>internal class CalNumber
{
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>并在主工程调用数字获取段落方法处改为：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>public string? Number
{
    get { return _number; }
    set
    {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>输入6时又返回1的段落了：</p><p>问题来了：internal方法怎么拦截？</p><p>我们不直接注释代码<code>mo = new CalNumber().GetValidNumber(mo);</code>，万一验证方法非常重要，我们只是需要修改其中部分逻辑，总体原逻辑不应该改变。</p><h3 id="_3-2-internal方法怎么拦截" tabindex="-1"><a class="header-anchor" href="#_3-2-internal方法怎么拦截"><span>3.2. internal方法怎么拦截？</span></a></h3><p>新增拦截类<code>HookGetValidNumber</code>，现在不能再在类上添加特性了（<code>[HarmonyPatch(typeof(CalNumber))]</code>），因为<code>CalNumber</code>不是public访问修饰，跨工程无法直接使用，语法不支持：</p><figure><img src="`+s+`" alt="图片" tabindex="0" loading="lazy"><figcaption>图片</figcaption></figure><p>特性用不上，那就手工注册需要拦截的方法，这是本文的重点，代码在下面，简单提一下：</p><ul><li>手工注册代码和自动注册声明特性类似，只是换个写法；</li><li>拦截替换方法需要使用<code>HarmonyMethod</code>方法包装；</li><li><code>harmony.Patch(hookMethod, replaceHarmonyMethod);</code>用于关联被拦截方法与替换方法</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>/// &lt;summary&gt;
/// 手工注册关联被拦截方法与替换方法
/// &lt;/summary&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>替换方法定义如下：</p><ul><li><code>Prefix</code>方法命名这里不加限制，只要和上面手工注册（<code>var replaceMethod = typeof(HookGetValidNumber).GetMethod(nameof(Prefix));</code>）相同即可：</li><li>数字等于6，修改伪造结果为8</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>/// &lt;summary&gt;
/// GetNumberSentence拦截替换方法
/// &lt;/summary&gt;
/// &lt;param name=&quot;__instance&quot;&gt;拦截的TestTool实例&lt;/param&gt;
/// &lt;param name=&quot;number&quot;&gt;GetNumberSentence方法同名参数定义，修改它达到方法参数篡改&lt;/param&gt;
