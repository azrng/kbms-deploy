import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as a,o as s,c as l,a as i,d as e,e as d,b as r}from"./app-DMmdIwn0.js";const o="/kbms/common/1613566907278-5449d987-b64b-4095-8bea-56c7a251fcfe.png",c="/kbms/common/1613566907280-898ead77-c8d3-46fc-8d13-1ce09385b0d5.png",m="/kbms/common/1613566907274-e0ac8530-9345-4122-b289-d24249438092.png",u={},v=r(`<p><strong>1.枚举类型</strong> //遍历枚举类型Sample的各个枚举名称</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>foreach (string sp in Enum.GetNames(typeof(Sample))) 
{ 
ary.Add(sp); 
} 
//遍历枚举类型Sample的各个枚举值 
