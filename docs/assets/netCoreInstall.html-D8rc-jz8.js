import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as a,d as s}from"./app-CBxp4zeL.js";const t={},l=s(`<h2 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件"><span>配置文件</span></a></h2><p>master-deployment.yaml</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>apiVersion: apps/v1
kind: Deployment
metadata:
  name: net-sample
  labels:
