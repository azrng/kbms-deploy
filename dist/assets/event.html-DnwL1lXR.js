import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as e,e as a}from"./app-vSdX8vi3.js";const t={},i=a(`<h2 id="代码隐藏" tabindex="-1"><a class="header-anchor" href="#代码隐藏"><span>代码隐藏</span></a></h2><p>在页面包含复杂的逻辑时候，可以添加一个该页面文件名的cs文件类来单独存储应用的逻辑，这个方法叫做代码隐藏。</p><p>页面初始化后触发的事件</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>protected override async Task <span class="token function-name function">OnInitializedAsync</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
