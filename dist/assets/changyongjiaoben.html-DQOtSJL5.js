import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,d as a,o as l}from"./app-BQsqMNmR.js";const e={};function p(t,s){return l(),n("div",null,s[0]||(s[0]=[a(`<h2 id="安装gitlab" tabindex="-1"><a class="header-anchor" href="#安装gitlab"><span>安装gitlab</span></a></h2><p>1.创建一个全新的虚拟机，并且至少有4g运行内存<br> 2.安装docker以及docker_compose<br> 3.将ssh的默认的22端口，修改为60022端口<br> vi /etc/ssh/sshd_config<br> port 22-&gt;60022<br> systemctl restart sshd<br> 4.docker-compose.yml文件去安装gitlab(下载和运行时间比较长)</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>version: &#39;3.1&#39;</span></span>
