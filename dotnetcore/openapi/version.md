...
> 注意：
>
>  _provider = services.BuildServiceProvider().GetRequiredService&lt;IApiVersionDescriptionProvider&gt;();会提示“ ASP0000 从应用程序代码调用“BuildServiceProvider”会导致创建单一实例服务的其他副本。 考虑依赖项注入服务等替代项作为“Configure”的参数。”
...
> 就必须写版本号，如果不写也没有设置不受版本控制，那么就会提示404

完结。



> 借鉴于：https://www.cnblogs.com/tiger-wang/p/14167625.html