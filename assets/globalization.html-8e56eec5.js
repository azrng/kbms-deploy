...
?culture=zh-CN
?ui-culture=zh-CN
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620739056710-32704399-15c8-4a13-88d9-1706658774d3.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h1 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h1>`,32),m={href:"https://docs.microsoft.com/zh-cn/aspnet/core/fundamentals/localization?view=aspnetcore-5.0",target:"_blank",rel:"noopener noreferrer"};function h(p,g){const a=l("ExternalLinkIcon");return t(),d("div",null,[u,e("p",null,[i("支持多语言使网站可以覆盖更广泛的受众。 "),e("a",o,[i("ASP.NET"),n(a)]),i(" Core 提供的服务和中间件可将网站本地化为不同的语言。")]),v,e("p",null,[e("a",m,[i("https://docs.microsoft.com/zh-cn/aspnet/core/fundamentals/localization?view=aspnetcore-5.0"),n(a)])])])}const f=r(c,[["render",h],["__file","globalization.html.vue"]]);export{f as default};
