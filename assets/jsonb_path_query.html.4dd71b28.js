...
<span class="token comment">-- 3</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="资料" tabindex="-1"><a class="header-anchor" href="#资料" aria-hidden="true">#</a> 资料</h1><blockquote><p>json和jsonb从用户操作角度来说是没有区别的，区别主要是存储和读取的系统处理和耗时方面有区别。json写入，读取慢，jsonb写入慢，读取快.</p></blockquote>`,24),r={href:"http://postgres.cn/docs/12/functions-json.html",target:"_blank",rel:"noopener noreferrer"};function d(m,q){const a=u("ExternalLinkIcon");return t(),o("div",null,[c,n("p",null,[s("中文教程地址："),n("a",r,[s("http://postgres.cn/docs/12/functions-json.html"),i(a)])])])}const b=e(p,[["render",d],["__file","jsonb_path_query.html.vue"]]);export{b as default};
