import{_ as a,W as s,X as r,Y as e,Z as d,$ as i,a0 as l,y as c}from"./framework.cf23f0c7.js";const t={},o=l(`<h1 id="linux安装docker" tabindex="-1"><a class="header-anchor" href="#linux安装docker" aria-hidden="true">#</a> Linux安装docker</h1><h1 id="安装条件" tabindex="-1"><a class="header-anchor" href="#安装条件" aria-hidden="true">#</a> 安装条件</h1><p>在centos 7安装docker要求系统64位，系统内核版本3.10以上，可以使用命令查看</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>uname -r
