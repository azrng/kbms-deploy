import{_ as d,W as s,X as t,Y as e,Z as n,$ as l,a0 as a,y as r}from"./framework.e8a0537a.js";const o={},c=e("h1",{id:"介绍",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#介绍","aria-hidden":"true"},"#"),n(" 介绍")],-1),v=e("p",null,"现如今大部分服务都会有用户输入，为了服务的正常运行，很多时候不得不针对输入进行敏感词的检测、替换。如果人工做这样的工作，不仅效率低，成本也高。所以，先让代码去处理输入，成为了经济方便的途径。",-1),u=e("h1",{id:"toolgood-words",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#toolgood-words","aria-hidden":"true"},"#"),n(" ToolGood.Words")],-1),b={href:"https://github.com/toolgood/ToolGood.Words",target:"_blank",rel:"noopener noreferrer"},m=e("p",null,[e("img",{src:"https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620891320700-cdaee58d-cfff-4bb2-b590-2f1823c5e595.png",alt:"img",loading:"lazy"})],-1),p=e("p",null,"通过简单的了解，我们可以知道它可以针对敏感词及其拼音、跳词等变形进行检测，在实际的应用场景中能满足大部分的需求。",-1),g={href:"https://www.cnblogs.com/chenug/p/9848852.html",target:"_blank",rel:"noopener noreferrer"},h=a(`<h1 id="validationattribute" tabindex="-1"><a class="header-anchor" href="#validationattribute" aria-hidden="true">#</a> ValidationAttribute</h1><p>我们先定义两个简单的模型来绑定输入参数，一个是只要输入含有敏感词就会报错，一个是只要输入含有敏感词就会把相关的字符串替换为 * ，代码如下：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class MinganCheckInput
    {
        [MinGanCheck]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="效果" tabindex="-1"><a class="header-anchor" href="#效果" aria-hidden="true">#</a> 效果</h1><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620891320662-0266f70c-87a8-4c05-9138-e498f773017b.png" alt="img" loading="lazy"></p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620891320658-04447a86-2dd4-477e-b67c-37e5368b37aa.png" alt="img" loading="lazy"></p><h1 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h1>`,16),y={href:"http://www.cnblogs.com/chenug",target:"_blank",rel:"noopener noreferrer"},G=e("strong",null,"张蘅水",-1),I={href:"https://www.cnblogs.com/chenug/p/ToolGood_Words_Sample.html",target:"_blank",rel:"noopener noreferrer"};function w(k,R){const i=r("ExternalLinkIcon");return s(),t("div",null,[c,v,u,e("p",null,[n("首先我们要使用的开源组件是 "),e("a",b,[n("ToolGood.Words"),l(i)])]),m,p,e("p",null,[n("具体的用法在这里不做过多的介绍，接下来我们需要做的事情是如何在现有代码中快速且方便的情况下接入敏感词组件。很显然，如果我们按照组件写的示例去操作，会发现需要在现有的代码中进行大量重构的操作，这显然会累垮 VS 。熟悉我的朋友首先就会想到使用 AOP 的方式去优化处理。（这里不过多介绍AOP，如果想了解更多，请移步 "),e("a",g,[n("C# 中使用面向切面编程（AOP）中实践代码整洁"),l(i)]),n(" )")]),h,e("p",null,[n("其中 "),x,n(" 和 "),_,n(" 是我们定义的特性标记，将其继承 "),e("a",f,[n("ValidationAttribute"),l(i)]),n("，就和我们常用的 "),C,n(" 一样方便，哪里敏感点哪里。")]),V,e("p",null,[n("作者："),e("a",y,[G,l(i)])]),e("p",null,[e("a",I,[n("https://www.cnblogs.com/chenug/p/ToolGood_Words_Sample.html"),l(i)])])])}const A=d(o,[["render",w],["__file","toolgood-words.html.vue"]]);export{A as default};
