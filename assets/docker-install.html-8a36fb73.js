...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><figure><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212101438856.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>输入找到的管理员密码然后进入系统</p><h2 id="_2-2-进入jenkins" tabindex="-1"><a class="header-anchor" href="#_2-2-进入jenkins" aria-hidden="true">#</a> 2.2 进入jenkins</h2><p>新手入门，选择安装插件的方式，这里我们直接选择安装推荐的插件然后进入系统</p><p>注意：安装插件报错的话继续在执行一遍。</p><h2 id="_2-3-设置管理员用户密码" tabindex="-1"><a class="header-anchor" href="#_2-3-设置管理员用户密码" aria-hidden="true">#</a> 2.3 设置管理员用户密码</h2><p>创建管理员用户密码</p><figure><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212101438670.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h2 id="_2-4-系统界面" tabindex="-1"><a class="header-anchor" href="#_2-4-系统界面" aria-hidden="true">#</a> 2.4 系统界面</h2><p>如果系统管理里面有错误，那么我们可以手动安装和修改。</p><h2 id="_2-5-修改镜像源" tabindex="-1"><a class="header-anchor" href="#_2-5-修改镜像源" aria-hidden="true">#</a> 2.5 修改镜像源</h2><p>插件管理-&gt;高级-&gt;升级站点，修改为清华大学插件源</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 清华大学官方镜像
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="_4-参考文档" tabindex="-1"><a class="header-anchor" href="#_4-参考文档" aria-hidden="true">#</a> 4 参考文档</h1>`,24),h={href:"https://www.jenkins.io/doc/book/installing/docker/",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.cnblogs.com/xiaoxiaotank/p/14762665.html",target:"_blank",rel:"noopener noreferrer"};function b(p,k){const i=s("ExternalLinkIcon");return c(),l("div",null,[t,e("p",null,[n("访问地址："),e("a",v,[n("http://IP:8080"),a(i)])]),u,e("p",null,[n("官方文档："),e("a",h,[n("https://www.jenkins.io/doc/book/installing/docker/"),a(i)])]),e("p",null,[n("xiaoxiaotank："),e("a",m,[n("https://www.cnblogs.com/xiaoxiaotank/p/14762665.html"),a(i)])])])}const x=d(o,[["render",b],["__file","docker-install.html.vue"]]);export{x as default};
