import{_ as l,W as t,X as r,Y as e,Z as i,$ as s,a0 as d,C as a}from"./framework-63781bb7.js";const o={},u=d(`<h1 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h1><p>模型绑定就是接收将来自HTTP请求的数据映射到模型的过程，这个过程是自动进行的。如果找不到模型属性的值，并不会报错，而是给该属性设置默认值。</p><p>示例：比如我们有一个接口为</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[HttpGet(&quot;{id}&quot;)]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>请求示例</p><figure><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1623573025670-a091a4da-90ce-4dec-b630-43ccaebabf91.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>接收结果</p><figure><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1623573080249-e2bc5bfc-bc98-490d-99cc-c5556f26f457.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h2 id="自定义模型绑定" tabindex="-1"><a class="header-anchor" href="#自定义模型绑定" aria-hidden="true">#</a> 自定义模型绑定</h2><p>示例场景：通过请求头传递后端自定义的一种token，通过自定义模型绑定将token解析后绑定到请求模型。</p>`,10),h={href:"https://www.cnblogs.com/jyzhu/articles/8670536.html",target:"_blank",rel:"noopener noreferrer"},q=d(`<p>请求接口示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>        [HttpGet]
