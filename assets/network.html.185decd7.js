...
spec:
 ...
 selector:
 name: influxdb
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="ingress" tabindex="-1"><a class="header-anchor" href="#ingress" aria-hidden="true">#</a> Ingress</h4><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/202112272323868.webp" alt="图片" loading="lazy"></p>`,41),m={href:"http://foo.bar.com",target:"_blank",rel:"noopener noreferrer"},g=a(`<p>其部署的 yaml 可以参考如下模板：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>apiVersion: extensions/v1beta1
kind: Ingress
metadata:
 name: test
 annotations:
...
spec:
 ...
 serviceName: s2
 servicePort: 80
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="总结及展望" tabindex="-1"><a class="header-anchor" href="#总结及展望" aria-hidden="true">#</a> 总结及展望</h3><p>本文针对 Kubernetes 的网络模型，从一个 service，二个IP，三个 port 出发进行图解。详解 Kubernetes 集群内及集群外部访问方式。</p>`,5);function f(I,_){const r=l("ExternalLinkIcon");return d(),t("div",null,[n("blockquote",null,[n("p",null,[e("文章来自："),n("a",c,[e("https://zhuanlan.zhihu.com/p/81667781"),i(r)])])]),v,n("p",null,[e("nodePort为外部机器提供了访问集群内服务的方式。比如一个Web应用需要被其他用户访问，那么需要配置type=NodePort，而且配置nodePort=30001，那么其他机器就可以通过浏览器访问scheme://node:30001访问到该服务，例如"),n("a",p,[e("http://node:30001"),i(r)]),e("。")]),u,n("p",null,[e("targetPort是容器的端口（最根本的端口入口），与制作容器时暴露的端口一致（DockerFile中EXPOSE），例如 "),n("a",h,[e("http://docker.io"),i(r)]),e(" 官方的 nginx 暴露的是80端口。")]),b,n("p",null,[e("Ingress 是推荐在生产环境使用的方式，它起到了七层负载均衡器和 Http 方向代理的作用，可以根据不同的 url 把入口流量分发到不同的后端Service。外部客户端只看到 "),n("a",m,[e("http://foo.bar.com"),i(r)]),e(" 这个服务器，屏蔽了内部多个 Service 的实现方式。采用这种方式，简化了客户端的访问，并增加了后端实现和部署的灵活性，可以在不影响客户端的情况下对后端的服务部署进行调整。")]),g,n("p",null,[e("这里我们定义了一个ingress模板，定义通过 "),n("a",P,[e("http://test.name.com"),i(r)]),e(" 来访问服务，在虚拟主机"),n("a",x,[e("http://test.name.com下面定义了两个Path"),i(r)]),e("，其中/test被分发到后端服务s1，/name被分发到后端服务s2。")]),k])}const S=s(o,[["render",f],["__file","network.html.vue"]]);export{S as default};
