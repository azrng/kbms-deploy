import{_ as r,W as t,X as a,Y as e,Z as n,$ as s,a0 as l,y as d}from"./framework.35562d63.js";const c={},u=l(`<h1 id="单元测试简单使用" tabindex="-1"><a class="header-anchor" href="#单元测试简单使用" aria-hidden="true">#</a> 单元测试简单使用</h1><h1 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h1><p>本文来演示一下同事教导后的写法，同样有些单元测试是为了演示而写的单元测试。</p><p>本文使用组件：Xunit、Moq以及dotNet相关知识</p><blockquote><p>注：本文内容基于上一篇</p></blockquote><h1 id="操作" tabindex="-1"><a class="header-anchor" href="#操作" aria-hidden="true">#</a> 操作</h1><p>首先指定一个方法编写单元测试，并且要保证没有其他因素干扰的情况下去进行单元测试。</p><h2 id="创建单元测试项目" tabindex="-1"><a class="header-anchor" href="#创建单元测试项目" aria-hidden="true">#</a> 创建单元测试项目</h2><p>参考上篇文章，在上篇文章的基础上进行如下代码。</p><h2 id="测试方法" tabindex="-1"><a class="header-anchor" href="#测试方法" aria-hidden="true">#</a> 测试方法</h2><p>首先先继承公共类，然后注入日志组件</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class UserServiceTest : BaseWebHostTest
{
