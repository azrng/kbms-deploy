import{_ as a,W as t,X as r,Y as e,Z as i,$ as d,a0 as n,y as l}from"./framework.e8a0537a.js";const c={},o=n(`<h2 id="登录信息保存" tabindex="-1"><a class="header-anchor" href="#登录信息保存" aria-hidden="true">#</a> 登录信息保存</h2><h3 id="_1-1-信息保存" tabindex="-1"><a class="header-anchor" href="#_1-1-信息保存" aria-hidden="true">#</a> 1.1 信息保存</h3><p>登录后用户的信息存入cookie中</p><p>保存验证结果; 用户id可以存入NameIdentifier，账号存入GivenName，姓名存入Name</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code> 				var claims = new List&lt;Claim&gt;
                {
