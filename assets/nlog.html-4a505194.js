import{_ as n,W as t,X as l,Y as e,Z as s,$ as a,a0 as r,C as d}from"./framework-63781bb7.js";const o={},u=r(`<h1 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍" aria-hidden="true">#</a> 1. 介绍</h1><p>NLog是适用于各种.NET平台（包括.NET标准）的灵活，免费的日志记录平台，支持数据库、文件、控制台。</p><h1 id="_2-输入到文件" tabindex="-1"><a class="header-anchor" href="#_2-输入到文件" aria-hidden="true">#</a> 2. 输入到文件</h1><h2 id="_2-1-引用nuget包" tabindex="-1"><a class="header-anchor" href="#_2-1-引用nuget包" aria-hidden="true">#</a> 2.1 引用nuget包</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    &lt;PackageReference Include=&quot;NLog&quot; Version=&quot;4.7.6&quot; /&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>查看日志文件</p><figure><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1619886030977-ef9d2c9c-fb94-41d7-a707-33eee277bbd9.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h1 id="_3-参考文档" tabindex="-1"><a class="header-anchor" href="#_3-参考文档" aria-hidden="true">#</a> 3. 参考文档</h1>`,17),v={href:"https://github.com/NLog/NLog/wiki/Getting-started-with-ASP.NET-Core-5",target:"_blank",rel:"noopener noreferrer"};function c(g,m){const i=d("ExternalLinkIcon");return t(),l("div",null,[u,e("p",null,[e("a",v,[s("https://github.com/NLog/NLog/wiki/Getting-started-with-ASP.NET-Core-5"),a(i)])])])}const q=n(o,[["render",c],["__file","nlog.html.vue"]]);export{q as default};
