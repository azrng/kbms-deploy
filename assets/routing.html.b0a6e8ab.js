import{_ as s,W as t,X as a,Y as i,Z as e,$ as d,a0 as l,y as r}from"./framework.e8a0537a.js";const o={},c=l(`<h1 id="routing" tabindex="-1"><a class="header-anchor" href="#routing" aria-hidden="true">#</a> Routing</h1><ul><li>Routing（路由）：更准确的应该叫做Endpoint Routing，负责将HTTP请求按照匹配规则选择对应的终结点</li><li>Endpoint（终结点）：负责当HTTP请求到达时，执行代码</li></ul><p>路由是通过<code>UseRouting</code>和<code>UseEndpoints</code>两个中间件配合在一起来完成注册的：</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>public class Startup
{
