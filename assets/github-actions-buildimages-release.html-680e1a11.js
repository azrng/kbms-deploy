import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as c,o as l,c as o,a as n,b as s,d as e,e as i}from"./app-77ed49ef.js";const p={},r=i('<h1 id="目的" tabindex="-1"><a class="header-anchor" href="#目的" aria-hidden="true">#</a> 目的</h1><p>通过GitHub的Action来(白嫖)部署.Net服务到阿里云服务器。</p><h1 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备" aria-hidden="true">#</a> 环境准备</h1><p>需要一个阿里云服务器并且该服务器还安装了docker环境，如果环境安装不清楚可以查看之前的文章。</p><h2 id="创建镜像仓库" tabindex="-1"><a class="header-anchor" href="#创建镜像仓库" aria-hidden="true">#</a> 创建镜像仓库</h2>',5),u={href:"http://xn--registry-wg0m435ebfa.cn-hangzhou.aliyuncs.com/zrng/myexample%E3%80%82",target:"_blank",rel:"noopener noreferrer"},d=n("h2",{id:"准备项目文件",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#准备项目文件","aria-hidden":"true"},"#"),s(" 准备项目文件")],-1),m={href:"https://gitee.com/AZRNG/my-example",target:"_blank",rel:"noopener noreferrer"},k=i(`<h1 id="隐私信息配置" tabindex="-1"><a class="header-anchor" href="#隐私信息配置" aria-hidden="true">#</a> 隐私信息配置</h1><p>在指定的仓库中，选择Settings=&gt;Secrets=&gt;Actions</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1662964788789-be6dab44-c8d3-47e5-92be-8b39ffad23f6.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>点击右上的新建就可以创建想要保存的隐私配置信息</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1662964862458-55292112-dc41-4232-96cb-361d761de2f1.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>这里我保存了一下镜像仓库的账号密码等信息。</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1665843728374-35195900-1e1e-4bbd-8dcd-7c00d728c66a.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><h1 id="仓库脚本配置" tabindex="-1"><a class="header-anchor" href="#仓库脚本配置" aria-hidden="true">#</a> 仓库脚本配置</h1><p>在仓库的根目录新建工作流文件.github/workflows/dotnet.yml(也可以在Actions选项卡中新建)，我们将每次提交的项目生成测试镜像，在dotnet.yml中写下面内容</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code><span class="token comment"># 工作流名称</span>
name: Docker
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在我们提交代码并推送中可以去github的Actions选项卡中查看</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1665844308787-738ddabc-da31-43b6-a4bd-9be0ffdf04ab.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>因为一些笨笨的操作，错误了好多次</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1665844353011-7d0d3c05-4f4b-4dd4-af52-9989a81e349b.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>然后再去阿里云镜像仓库查看是否有我们推送上去的镜像</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1665886329351-b8fb20ce-79e1-4eed-bf80-af6a635d0e29.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>已经存在，说明我们生成镜像并推送的步骤成功了，也可以通过以下命令拉取到</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code>docker pull registry.cn-hangzhou.aliyuncs.com/zrng/myexample:latest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h1 id="部署镜像" tabindex="-1"><a class="header-anchor" href="#部署镜像" aria-hidden="true">#</a> 部署镜像</h1><p>我们需要让推送成功后，在我们的阿里云服务器上拉取镜像并启动，那么先增加服务器的地址、账号、密码、端口等变量</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1665845286503-fa50bdbb-50d3-4224-a441-20b362ec21cf.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>再修改dotnet.yml文件，在最后追加内容</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># 列出所有镜像    </span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>然后我提交新增加的代码，等工作流跑结束后</p><figure><img src="https://cdn.nlark.com/yuque/0/2022/png/272869/1665846823299-709de572-91b1-4ab5-b6bc-47b157e6a75a.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure>`,32),v={href:"http://IP:8002/swagger/index.html",target:"_blank",rel:"noopener noreferrer"},b=n("figure",null,[n("img",{src:"https://cdn.nlark.com/yuque/0/2022/png/272869/1665846875139-b5149b0d-f349-44f9-91fa-82db7e976cbf.png",alt:"img",tabindex:"0",loading:"lazy"}),n("figcaption",null,"img")],-1),g=n("p",null,"登录服务器后查看镜像版本，也是我们刚刚推送的镜像。",-1),h=n("h1",{id:"总结",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#总结","aria-hidden":"true"},"#"),s(" 总结")],-1),y={href:"http://xn--ASP-zr0f.NET",target:"_blank",rel:"noopener noreferrer"},f=n("p",null,"如果想在每次dev提交代码后自动生成服务(不再推送镜像仓库)，那么可以稍稍修改上面的脚本使用appleboy/ssh-action@master进入某一个目录(提前拉取好项目的目录)，然后构建镜像生成容器。",-1),_=n("h1",{id:"资料",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#资料","aria-hidden":"true"},"#"),s(" 资料")],-1),R={href:"https://gitee.com/AZRNG/my-example",target:"_blank",rel:"noopener noreferrer"},E={href:"https://gitee.com/AZRNG/my-example/blob/master/.github/workflows/dotnet.yml",target:"_blank",rel:"noopener noreferrer"};function x(w,A){const a=c("ExternalLinkIcon");return l(),o("div",null,[r,n("p",null,[s("在阿里云的容器镜像服务中，创建一个镜像仓库用来存储我们测试的镜像，这里我提前创建仓库为myexample，"),n("a",u,[s("地址为registry.cn-hangzhou.aliyuncs.com/zrng/myexample。"),e(a)])]),d,n("p",null,[s("本文主要讨论GitHub的Action功能，所以项目文件直接使用之前示例代码，在Github创建仓库my-example，该仓库的代码使用之前的代码(仓库地址为："),n("a",m,[s("https://gitee.com/AZRNG/my-example"),e(a)]),s(")")]),k,n("p",null,[s("访问我们项目的swagger("),n("a",v,[s("http://IP:8002/swagger/index.html"),e(a)]),s(")页面(前提是阿里云服务器的端口安全组已经设置)，既可以看到下面的效果")]),b,g,h,n("p",null,[s("本文完整介绍了如何使用Github Actions做CI&CD，"),n("a",y,[s("将ASP.NET"),e(a)]),s(" Core 6.0 程序的main分支打包并部署到阿里云Linux服务器。")]),f,_,n("p",null,[s("本文完整代码可以查看仓库："),n("a",R,[s("https://gitee.com/AZRNG/my-example"),e(a)])]),n("p",null,[s("完整的dotnet.yaml文件可以查看："),n("a",E,[s("https://gitee.com/AZRNG/my-example/blob/master/.github/workflows/dotnet.yml"),e(a)])])])}const q=t(p,[["render",x],["__file","github-actions-buildimages-release.html.vue"]]);export{q as default};
