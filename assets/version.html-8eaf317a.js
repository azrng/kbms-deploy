import{_ as s}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as d,c as a,a as e,b as i,d as l,e as v}from"./app-77ed49ef.js";const t={},o=v(`<h2 id="_1-安装组件" tabindex="-1"><a class="header-anchor" href="#_1-安装组件" aria-hidden="true">#</a> 1. 安装组件</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    &lt;PackageReference Include=&quot;Microsoft.AspNetCore.Mvc.Versioning&quot; Version=&quot;4.2.0&quot; /&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>就必须写版本号，如果不写也没有设置不受版本控制，那么就会提示404</p></blockquote><p>完结。</p>`,34),c={href:"https://www.cnblogs.com/tiger-wang/p/14167625.html",target:"_blank",rel:"noopener noreferrer"};function u(m,p){const n=r("ExternalLinkIcon");return d(),a("div",null,[o,e("blockquote",null,[e("p",null,[i("借鉴于："),e("a",c,[i("https://www.cnblogs.com/tiger-wang/p/14167625.html"),l(n)])])])])}const h=s(t,[["render",u],["__file","version.html.vue"]]);export{h as default};
