import{_ as l}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as r,c as a,a as e,b as i,d as s,e as d}from"./app-3c3dee46.js";const o={},u=d(`<h1 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h1><p>模型绑定就是接收将来自HTTP请求的数据映射到模型的过程，这个过程是自动进行的。如果找不到模型属性的值，并不会报错，而是给该属性设置默认值。</p><p>示例：比如我们有一个接口为</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[HttpGet(&quot;{id}&quot;)]
