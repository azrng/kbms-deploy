import{_ as l,W as a,X as t,Y as e,Z as i,$ as s,a0 as d,y as r}from"./framework.cf23f0c7.js";const c={},v=d(`<h1 id="git基本原理" tabindex="-1"><a class="header-anchor" href="#git基本原理" aria-hidden="true">#</a> Git基本原理</h1><p>简单地说，Git 究竟是怎样的一个系统呢？请注意接下来的内容非常重要，若你理解了 Git 的思想和基本工作原理，用起来就会知其所以然，游刃有余。在学习 Git 时，请尽量理清你对其它版本管理系统已有的认识，如 CVS、Subversion 或 Perforce， 这样能帮助你使用工具时避免发生混淆。尽管 Git 用起来与其它的版本控制系统非常相似， 但它在对信息的存储和认知方式上却有很大差异，理解这些差异将有助于避免使用中的困惑。</p><p><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212111142324.webp" alt="图片" loading="lazy"></p><h3 id="git-初始化代码仓库" tabindex="-1"><a class="header-anchor" href="#git-初始化代码仓库" aria-hidden="true">#</a> Git 初始化代码仓库</h3><p>执行完成了 git init 命令，究竟做了什么呢？</p><p>执行完成如下命令之后，我们可以得到下图所示的内容，右侧的就是 Git 为我们创建的代码仓库，其中包含了用于版本管理所需要的内容。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 左边执行
$ mkdir git-demo
...
# 右边执行
$ watch -n 1 -d find .
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212111142252.webp" alt="img" loading="lazy"></p><p>我们这里可以一起看下生成的 .git 目录的结构如何：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>➜ tree .git
.git
├── HEAD
├── config
├── description
...
└── refs
    ├── heads
    └── tags
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>.git/config - 当前代码仓库本地的配置文件</strong></p>`,11),m=e("li",null,"本地配置文件（.git/config）和全局配置文件（~/.gitconfig）",-1),u=e("li",null,"通过执行如下命令，可以将用户配置记录到本地代码仓库的配置文件中去",-1),o={href:"http://user.name",target:"_blank",rel:"noopener noreferrer"},b=e("li",null,[i('git config user.email "'),e("a",{href:"mailto:demo@demo.com"},"demo@demo.com"),i('"')],-1),g=d(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>➜ cat .git/config
[core]
...
# 右边执行
$ glo = git log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212111143528.webp" alt="图片" loading="lazy"></p><h3 id="checkout-和-commit-操作" tabindex="-1"><a class="header-anchor" href="#checkout-和-commit-操作" aria-hidden="true">#</a> checkout 和 commit 操作</h3><p>我们一起聊一聊，checkout 和 commit 的操作！</p><p>我们执行 checkout 命令的时候，其不光可以切换分支，而且可以切换到指定的 commit 上面，即 HEAD 文件会指向某个 commit 对象。在 Git 里面，将 HEAD 文件没有指向 master 的这个现象称之为 detached HEAD。</p><p>这里不管 HEAD 文件指向的是分支名称也好，是 commit 对象也罢，其实本质都是一样的，因为分支名称也是指向某个 commit 对象的。</p><p><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212111143281.webp" alt="图片" loading="lazy"></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code># 左边执行
$ git checkout 6e4a700
$ git log

# 右边执行
$ glo = git log
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.jsdelivr.net/gh/azrng/file/blog/202212111143178.webp" alt="图片" loading="lazy"></p><p>当我们切换到指定的 commit 的时候，如果需要在对应的 commit 上继续修改代码提交的话，可以使用上述图片中提及的 swtich 命令创建新分支，再进行提交。但是，通常我们都不会着玩，都会使用 checkout 命令来创建新分支的。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>$ git checkout -b tmp
$ git log
