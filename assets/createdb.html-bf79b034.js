...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="生成数据库" tabindex="-1"><a class="header-anchor" href="#生成数据库" aria-hidden="true">#</a> 生成数据库</h1><p>启动项目，自动生成数据库</p><figure><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620546536896-91cc7623-b6fa-457c-acec-d465cb06428e.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>表结构如下</p><figure><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620546396376-896cc74f-197e-465e-811f-168ff86485c4.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>如果后期数据库字段或者结构有变动，可以再次生成迁移文件然后生成数据库</p><h1 id="查询数据" tabindex="-1"><a class="header-anchor" href="#查询数据" aria-hidden="true">#</a> 查询数据</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    /// &lt;summary&gt;
    /// 用户接口
    /// &lt;/summary&gt;
