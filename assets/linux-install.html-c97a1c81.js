import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r,o as s,c as l,a as e,b as d,d as i,e as c}from"./app-3c3dee46.js";const t={},o=c(`<h1 id="linux安装docker" tabindex="-1"><a class="header-anchor" href="#linux安装docker" aria-hidden="true">#</a> Linux安装docker</h1><h1 id="安装条件" tabindex="-1"><a class="header-anchor" href="#安装条件" aria-hidden="true">#</a> 安装条件</h1><p>在centos 7安装docker要求系统64位，系统内核版本3.10以上，可以使用命令查看</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>uname -r
...
yum update -y
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="资料" tabindex="-1"><a class="header-anchor" href="#资料" aria-hidden="true">#</a> 资料</h1>`,44),u={href:"https://docs.docker.com/engine/install/centos/",target:"_blank",rel:"noopener noreferrer"},v=e("p",null,"离线安装模式",-1),m={href:"https://www.cnblogs.com/kingsonfu/p/11576797.html",target:"_blank",rel:"noopener noreferrer"};function p(b,g){const n=r("ExternalLinkIcon");return s(),l("div",null,[o,e("p",null,[d("官方教程："),e("a",u,[d("https://docs.docker.com/engine/install/centos/"),i(n)])]),v,e("p",null,[d("查看博客："),e("a",m,[d("https://www.cnblogs.com/kingsonfu/p/11576797.html"),i(n)])])])}const k=a(t,[["render",p],["__file","linux-install.html.vue"]]);export{k as default};
