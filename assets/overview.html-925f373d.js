import{_ as i}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as l,c as r,a as e,b as s,d as n,e as p}from"./app-3c3dee46.js";const c={},d=p(`<h1 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h1><p>创建好连接上linux系统</p><p>然后我们需要先添加yum源，命令</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>rpm -Uvh https://packages.microsoft.com/config/centos/7/packages-microsoft-prod.rpm
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>然后升级所有包的同时也升级软件和系统内核</p><p>命令：yum update</p><p>或者命令：yum upgrade</p><h1 id="安装脚本" tabindex="-1"><a class="header-anchor" href="#安装脚本" aria-hidden="true">#</a> 安装脚本</h1><p>centos 安装netstat</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> net-tools
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="权限" tabindex="-1"><a class="header-anchor" href="#权限" aria-hidden="true">#</a> 权限</h1><p>进入要修改权限的文件夹所在目录</p><p>sudo chmod -R 777 文件夹名</p><p>注意：</p><p>【注】 -R 是指级联应用到目录里的所有子目录和文件</p><p>777 是所有用户都拥有最高权限</p><h1 id="教程" tabindex="-1"><a class="header-anchor" href="#教程" aria-hidden="true">#</a> 教程</h1>`,42),o={href:"https://www.cnblogs.com/pengyunjing/p/10441944.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.centoschina.cn/safe/centossafe/9488.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://mp.weixin.qq.com/s/lLtbR3BihvOfVJv5VBj0AQ",target:"_blank",rel:"noopener noreferrer"};function u(b,h){const a=t("ExternalLinkIcon");return l(),r("div",null,[d,e("p",null,[s("常用linux命令 "),e("a",o,[s("https://www.cnblogs.com/pengyunjing/p/10441944.html"),n(a)])]),e("p",null,[s("关于阿里云centos服务器的一些安全性设置 "),e("a",m,[s("https://www.centoschina.cn/safe/centossafe/9488.html"),n(a)])]),e("p",null,[s("日常必备的16个linux命令："),e("a",v,[s("https://mp.weixin.qq.com/s/lLtbR3BihvOfVJv5VBj0AQ"),n(a)])])])}const y=i(c,[["render",u],["__file","overview.html.vue"]]);export{y as default};
