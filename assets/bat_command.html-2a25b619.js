import{_ as s,V as n,W as a,$ as e}from"./framework-fde89294.js";const o={},p=e(`<p>删除文件</p><div class="language-csharp line-numbers-mode" data-ext="cs"><pre class="language-csharp"><code><span class="token comment">//删除download文件夹中的文件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,7),t=[p];function c(l,r){return n(),a("div",null,t)}const i=s(o,[["render",c],["__file","bat_command.html.vue"]]);export{i as default};
