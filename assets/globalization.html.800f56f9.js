...
?culture=zh-CN
?ui-culture=zh-CN
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620739056710-32704399-15c8-4a13-88d9-1706658774d3.png" alt="img" loading="lazy"></p><h1 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h1>`,32),h={href:"https://docs.microsoft.com/zh-cn/aspnet/core/fundamentals/localization?view=aspnetcore-5.0",target:"_blank",rel:"noopener noreferrer"};function m(p,b){const i=l("ExternalLinkIcon");return t(),s("div",null,[u,e("p",null,[a("支持多语言使网站可以覆盖更广泛的受众。 "),e("a",o,[a("ASP.NET"),n(i)]),a(" Core 提供的服务和中间件可将网站本地化为不同的语言。")]),v,e("p",null,[e("a",h,[a("https://docs.microsoft.com/zh-cn/aspnet/core/fundamentals/localization?view=aspnetcore-5.0"),n(i)])])])}const x=r(c,[["render",m],["__file","globalization.html.vue"]]);export{x as default};
