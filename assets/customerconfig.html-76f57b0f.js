...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,4);function m(g,b){const s=a("ExternalLinkIcon");return r(),l("div",null,[u,i("p",null,[e("参考自："),i("a",v,[e("https://gitee.com/laozhangIsPhi/Blog.Core"),d(s)])]),c])}const h=t(o,[["render",m],["__file","customerconfig.html.vue"]]);export{h as default};
