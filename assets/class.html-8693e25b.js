import{_ as a}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as l,c as r,a as e,b as i,d as v,e as n}from"./app-77ed49ef.js";const t={},c=n(`<h1 id="开篇语" tabindex="-1"><a class="header-anchor" href="#开篇语" aria-hidden="true">#</a> 开篇语</h1><p>本文是读书笔记</p><h1 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h1><p>类是最常见的一种引用类型，最简单的声明如下</p><div class="language-c# line-numbers-mode" data-ext="c#"><pre class="language-c#"><code>class User { }       
...
dog.Cry();  // 二哈 在叫
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,16);function b(p,o){const s=d("ExternalLinkIcon");return l(),r("div",null,[c,e("p",null,[i("参考资料："),e("a",u,[i("https://www.cnblogs.com/ezhar/p/12864342.html"),v(s)])]),m])}const x=a(t,[["render",b],["__file","class.html.vue"]]);export{x as default};
