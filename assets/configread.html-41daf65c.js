...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,27),v={href:"https://docs.microsoft.com/zh-cn/aspnet/core/fundamentals/configuration/options?view=aspnetcore-5.0#ios",target:"_blank",rel:"noopener noreferrer"};function c(b,m){const n=a("ExternalLinkIcon");return s(),d("div",null,[u,e("blockquote",null,[e("p",null,[i("程序启动后再修改 JSON 配置文件所做的更改获取不到。 若要读取在应用启动后的更改，请使用 "),e("a",v,[i("IOptionsSnapshot"),o(n)])])])])}const h=t(l,[["render",c],["__file","configread.html.vue"]]);export{h as default};
