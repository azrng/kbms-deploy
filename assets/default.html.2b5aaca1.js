...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h1 id="生命周期" tabindex="-1"><a class="header-anchor" href="#生命周期" aria-hidden="true">#</a> 生命周期</h1><p>AddSingleton→AddTransient→AddScoped</p><p>被注入的服务应该与注入的服务具有相同或者更长的生命周期</p><h2 id="singleton-单例" tabindex="-1"><a class="header-anchor" href="#singleton-单例" aria-hidden="true">#</a> Singleton(单例)</h2><p>服务在第一次请求时被创建（或者当我们在ConfigureServices中指定创建某一实例并运行方法），其后的每次请求将沿用已创建服务。当应用程序关闭并释放SericeProvider时候，会释放单例服务。</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620437795433-1878377b-ead3-4b6b-a749-87f27b0907c0.png" alt="img" loading="lazy"></p>`,17),u={href:"https://blog.csdn.net/weixin_47498376/article/details/116177389",target:"_blank",rel:"noopener noreferrer"},o=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>services.AddSingleton&lt;IApplicationService,ApplicationService&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>比如有状态的、静态类和成员。</p><h2 id="scoped-作用域" tabindex="-1"><a class="header-anchor" href="#scoped-作用域" aria-hidden="true">#</a> Scoped(作用域)</h2><p>一次请求开始到请求结束 ，这次请求中获取的对象都是同一个，请求结束时候会释放有作用域的服务。</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620437843902-34480f40-cbe1-4cad-a5bd-4f1c84cfca78.png" alt="img" loading="lazy"></p>`,5),m={href:"https://blog.csdn.net/weixin_47498376/article/details/116177389",target:"_blank",rel:"noopener noreferrer"},b=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>services.AddScoped&lt;IApplicationService,ApplicationService&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果该service在一个请求过程中多次被用到，并且可能共享其中的字段或者属性，那么就使用scoped，例如httpcontext。 (感谢群里老哥的帮助)</p><h2 id="transient-瞬时" tabindex="-1"><a class="header-anchor" href="#transient-瞬时" aria-hidden="true">#</a> Transient(瞬时)</h2><p>每一次获取的对象都不是同一个，适合于轻量级、无状态的服务，请求结束时候会释放服务。</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1620437917664-c31fe30a-c429-4d5a-b66b-4a065089dd92.png" alt="img" loading="lazy"></p>`,5),p={href:"https://blog.csdn.net/weixin_47498376/article/details/116177389",target:"_blank",rel:"noopener noreferrer"},h=s(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>services.AddTransient&lt;IApplicationService,ApplicationService&gt;
