...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,18),o={href:"https://www.cnblogs.com/dcz2015/p/10943759.html",target:"_blank",rel:"noopener noreferrer"},g=t(`<h2 id="dllimport" tabindex="-1"><a class="header-anchor" href="#dllimport" aria-hidden="true">#</a> DllImport</h2><p>DllImport特性，可以让我们调用非托管代码，所以我们可以使用DllImport特性引入对Win32 API函数的调用</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>[System.Runtime.InteropServices.DllImport(&quot;user32.dll&quot;)]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="conditional" tabindex="-1"><a class="header-anchor" href="#conditional" aria-hidden="true">#</a> Conditional</h2><p>Conditional特性，用于条件编译，在调试时使用。注意：Conditional不可应用于数据成员和属性。</p><h1 id="自定义特性" tabindex="-1"><a class="header-anchor" href="#自定义特性" aria-hidden="true">#</a> 自定义特性</h1>`,9),h={href:"https://docs.microsoft.com/zh-cn/dotnet/api/system.attribute",target:"_blank",rel:"noopener noreferrer"},p=t(`<div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Struct, AllowMultiple = true)]
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>GetCustomAttributes 会以数组形式返回 Author 对象和任何其他特性对象</p><h1 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h1>`,9),x={href:"https://docs.microsoft.com/zh-cn/dotnet/csharp/programming-guide/concepts/attributes/",target:"_blank",rel:"noopener noreferrer"},f={href:"https://www.cnblogs.com/long2006sky/archive/2007/10/19/930094.html",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.cnblogs.com/dcz2015/p/10943759.html",target:"_blank",rel:"noopener noreferrer"},A=t(`<h1 id="rabbitmq自定义属性" tabindex="-1"><a class="header-anchor" href="#rabbitmq自定义属性" aria-hidden="true">#</a> RabbitMq自定义属性</h1><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    /// &lt;summary&gt;
    /// 自定义RabbitMQ队列注解
    /// &lt;/summary&gt;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4);function q(_,S){const n=r("ExternalLinkIcon");return l(),d("div",null,[v,e("p",null,[i("使用特性，可以有效地将元数据或声明性信息与代码（程序集、类型、方法、属性等）相关联。 将特性与程序实体相关联后，可以在运行时使用 反射 这项技术查询特性。"),e("a",b,[i("详情"),s(n)]),i(" 用于添加元数据，如编译器指令和注释、描述、方法、类等其他信息。.Net 框架提供了两种类型的特性：预定义特性和自定义特性。")]),m,e("p",null,[i("该例子摘抄自："),e("a",o,[i("https://www.cnblogs.com/dcz2015/p/10943759.html"),s(n)])]),g,e("p",null,[i("可通过定义特性类创建自己的自定义特性，特性类是直接或间接派生自 "),e("a",h,[i("Attribute"),s(n)]),i(" 的类，可快速轻松地识别元数据中的特性定义。假设我们希望使用编写类的程序员名字来标记该类，那么我们就需要自定义一个Author特性类")]),p,e("p",null,[e("a",x,[i("https://docs.microsoft.com/zh-cn/dotnet/csharp/programming-guide/concepts/attributes/"),s(n)])]),e("p",null,[e("a",f,[i("https://www.cnblogs.com/long2006sky/archive/2007/10/19/930094.html"),s(n)])]),e("p",null,[e("a",y,[i("https://www.cnblogs.com/dcz2015/p/10943759.html"),s(n)])]),A])}const D=a(c,[["render",q],["__file","attribute.html.vue"]]);export{D as default};
