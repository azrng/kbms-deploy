...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,15),u={href:"http://localhost:5000/redishealth",target:"_blank",rel:"noopener noreferrer"},o={href:"http://localhost:5000/redishealth",target:"_blank",rel:"noopener noreferrer"},m=s('<p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1619445707290-24896cd8-84f8-4c04-b00d-7d9905838b1b.png" alt="img" loading="lazy"></p><h1 id="_3-第三包支持" tabindex="-1"><a class="header-anchor" href="#_3-第三包支持" aria-hidden="true">#</a> 3. 第三包支持</h1><h2 id="_3-1-介绍" tabindex="-1"><a class="header-anchor" href="#_3-1-介绍" aria-hidden="true">#</a> 3.1 介绍</h2><p>是一个用于.NetCore健康检查的包，支持的版本有：5.0，3.1，3.0，2.2</p>',4),p={href:"https://github.com/xabaril/AspNetCore.Diagnostics.HealthChecks",target:"_blank",rel:"noopener noreferrer"},b=s(`<p>支持一一些封装的检查</p><ul><li><p>Sql Server</p></li><li><p>MySql</p></li><li><p>Oracle</p></li><li><p>Sqlite</p></li><li><p>RavenDB</p></li><li><p>Postgres</p></li><li><p>EventStore</p></li><li><p>RabbitMQ</p></li><li><p>IbmMQ</p></li><li><p>Elasticsearch</p></li><li><p>CosmosDb</p></li><li><p>Solr</p></li><li><p>Redis</p></li><li><p>SendGrid</p></li><li><p>System: Disk Storage, Private Memory, Virtual Memory, Process, Windows Service</p></li><li><p>Azure Service Bus: EventHub, Queue and Topics</p></li><li><p>Azure Storage: Blob, Queue and Table</p></li><li><p>Azure Key Vault</p></li><li><p>Azure DocumentDb</p></li><li><p>Azure IoT Hub</p></li><li><p>Amazon DynamoDb</p></li><li><p>Amazon S3</p></li><li><p>Google Cloud Firestore</p></li><li><p>Network: Ftp, SFtp, Dns, Tcp port, Smtp, Imap, Ssl</p></li><li><p>MongoDB</p></li><li><p>Kafka</p></li><li><p>Identity Server</p></li><li><p>Uri: single uri and uri groups</p></li><li><p>Consul</p></li><li><p>Hangfire</p></li><li><p>SignalR</p></li><li><p>Kubernetes</p></li><li><p>ArangoDB</p></li><li><p>Gremlin</p></li></ul><p>对应的Nuget包为</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Install-Package AspNetCore.HealthChecks.System
