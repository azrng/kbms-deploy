import{_ as l,W as s,X as n,Y as e,Z as a,$ as t,a0 as d,y as r}from"./framework.35562d63.js";const c={},o=d(`<h1 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h1><h2 id="生成容器" tabindex="-1"><a class="header-anchor" href="#生成容器" aria-hidden="true">#</a> 生成容器</h2><p>下面的脚本只是测试使用，不建议生产使用(像一些挂载的需要自行处理)</p><h3 id="docker-compose" tabindex="-1"><a class="header-anchor" href="#docker-compose" aria-hidden="true">#</a> docker-compose</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>version: &#39;3&#39;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>-d：后台运行</p><p>-p：将容器内部端口向外映射</p><p>--name：命名容器名称</p><p>-v：将容器内数据文件夹或者日志、配置等文件夹挂载到宿主机指定目录</p><h2 id="配置" tabindex="-1"><a class="header-anchor" href="#配置" aria-hidden="true">#</a> 配置</h2><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630392393921-c9133767-a427-43ac-b77a-96685c75485b.png" alt="img" loading="lazy"></p><p>进入容器内去编辑配置或者编辑挂载目录的文件</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630392436742-b7a1a83e-d915-430d-a960-f1612a97a4e4.png" alt="img" loading="lazy"></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>docker exec -it gitlab bash
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630392346545-d3be811e-20e6-4b75-85a2-1981b345a0af.png" alt="img" loading="lazy"></p><h3 id="容器内修改密码" tabindex="-1"><a class="header-anchor" href="#容器内修改密码" aria-hidden="true">#</a> 容器内修改密码</h3><p>在容器内进入gitlab的bin目录</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>cd /opt/gitlab/bin
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>执行gitlab-rails console命令</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630393079166-dcd56a70-64f3-41dd-8e48-4d97d69cbdf5.png" alt="img" loading="lazy"></p><p>找到root的用户，输入u=User.where(id:1).first，然后回车</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630393092662-6540ad2c-d30e-4bee-8dac-48b234344ede.png" alt="img" loading="lazy"></p><p>修改password，输入u.password=&#39;123456789&#39;然后回车</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>u.password=&#39;123456789&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630393112625-6ee295f7-70e6-4a1c-a3f0-194d972f223c.png" alt="img" loading="lazy"></p><p>修改确认密码</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>u.password_confirmation=&#39;123456789&#39;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630393132266-4b5613af-43c7-41cf-88ec-da38a3db7e70.png" alt="img" loading="lazy"></p><p>保存修改，输入u.save，然后回车，等到输出true，这时，密码修改成功。</p><p><img src="https://gitee.com/AZRNG/picture-storage/raw/master/kbms/1630393150839-203c3d29-88c8-4c59-9af1-273e8bce2933.png" alt="img" loading="lazy"></p><p>这里密码已经修改成功，可以用123456789密码登录进去了</p><h1 id="注意点" tabindex="-1"><a class="header-anchor" href="#注意点" aria-hidden="true">#</a> 注意点</h1><p>因为我们想是实现将容器内的80端口往外映射，所以我们在docker run的时候设置了-p 9006:80，但是因为我们在代码里面配置了external_url http://172.30.112.1:9006后就应该使用-p 9006:9006否则一直访问不到。</p><h1 id="参考文档" tabindex="-1"><a class="header-anchor" href="#参考文档" aria-hidden="true">#</a> 参考文档</h1>`,48),b={href:"https://blog.csdn.net/weixin_45649746/article/details/119816809",target:"_blank",rel:"noopener noreferrer"},g={href:"https://www.cnblogs.com/hellotim/p/13382565.html",target:"_blank",rel:"noopener noreferrer"};function m(v,u){const i=r("ExternalLinkIcon");return s(),n("div",null,[o,e("p",null,[a("docker安装gitlab： "),e("a",b,[a("https://blog.csdn.net/weixin_45649746/article/details/119816809"),t(i)])]),e("p",null,[a("netcore配置gitlab ci/cd："),e("a",g,[a("https://www.cnblogs.com/hellotim/p/13382565.html"),t(i)])])])}const h=l(c,[["render",m],["__file","gitlabinstall.html.vue"]]);export{h as default};
