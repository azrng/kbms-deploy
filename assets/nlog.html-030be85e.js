import{_ as n,V as t,W as l,X as e,Y as s,Z as a,$ as r,C as d}from"./framework-fde89294.js";const o={},u=r(`<h1 id="_1-介绍" tabindex="-1"><a class="header-anchor" href="#_1-介绍" aria-hidden="true">#</a> 1. 介绍</h1><p>NLog是适用于各种.NET平台（包括.NET标准）的灵活，免费的日志记录平台，支持数据库、文件、控制台。</p><h1 id="_2-输入到文件" tabindex="-1"><a class="header-anchor" href="#_2-输入到文件" aria-hidden="true">#</a> 2. 输入到文件</h1><h2 id="_2-1-引用nuget包" tabindex="-1"><a class="header-anchor" href="#_2-1-引用nuget包" aria-hidden="true">#</a> 2.1 引用nuget包</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>    &lt;PackageReference Include=&quot;NLog&quot; Version=&quot;4.7.6&quot; /&gt;
